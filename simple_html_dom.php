...
// $html = file_get_html('C:\patee-au-saumon-100g.html');


// foreach($html->find('h1') as $produit) {
	// echo $produit;
// }



// foreach($html->find('.infoProduitMdd') as $enseigne) {
	
	// echo $enseigne;
	// $item['prix'] = $enseigne->find('.prixMoyen',0)->plaintext;
	// echo $item['prix'];
